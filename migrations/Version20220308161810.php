 ...
 */
final class Version20220308161810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE valoracion (id INT AUTO_INCREMENT NOT NULL, autor_id INT DEFAULT NULL, libro_id INT DEFAULT NULL, puntuacion DOUBLE PRECISION NOT NULL, fecha_publicacion DATETIME NOT NULL, INDEX IDX_6D3DE0F414D45BBE (autor_id), INDEX IDX_6D3DE0F4C0238522 (libro_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE valoracion ADD CONSTRAINT FK_6D3DE0F414D45BBE FOREIGN KEY (autor_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE valoracion ADD CONSTRAINT FK_6D3DE0F4C0238522 FOREIGN KEY (libro_id) REFERENCES libro (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE valoracion DROP FOREIGN KEY FK_6D3DE0F4C0238522');
        ...
        $this->addSql('ALTER TABLE valoracion DROP FOREIGN KEY FK_6D3DE0F414D45BBE');
